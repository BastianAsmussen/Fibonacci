...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (sequence) {
            ...
            for (long i = 0; i < n; i++) fibonacciValue.append(fibonacci(i)).append(", ");

            fibonacciValue.deleteCharAt(fibonacciValue.length() - 1);

        } else fibonacciValue.append(fibonacciNumber);
